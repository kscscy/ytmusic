...
wavesurfer.on('ready', function () {
	...
	seekslider.addEventListener("mousedown", function(event){ seeking=true; seeksl(event); });
	seekslider.addEventListener("mousemove", function(event){ seeksl(event); });
	...
	// 재생 슬라이더
	function seeksl(event){
    if(seeking){
      console.log(seekslider.value);
	    //seekslider.value = event.clientX - seekslider.offsetLeft;
	    //console.log("mouse : " + event.clientX);
	    //console.log("offset : " + seekslider.offsetLeft);
	    //console.log(seekslider.value);
	    console.log(seekslider.value/100);
	    wavesurfer.seekTo(seekslider.value/100);
	    console.log("getcurrent:"+wavesurfer.getCurrentTime()/60);
	    console.log("getDuration:"+wavesurfer.getDuration()/60);
	    
	    //seekto = audio.duration * (seekslider.value / 100);
	    //audio.currentTime = seekto;
	   //wavesurfer.seekTo(wavesurfer.getDuration() * seekslider.value/100);
	   // wavesurfer.skip(wavesurfer.seekTo(wavesurfer.getDuration() * seekslider.value/100));
    }
  }
