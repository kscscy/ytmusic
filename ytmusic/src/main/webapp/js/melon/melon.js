...
function userprofile() {
  PlanetX.api("get", "http://apis.skplanetx.com/melon/newreleases/albums?count=10&page=1&version=1", "JSON", {'version': 1}, mainSlider_today);
};
...
function userprofile3() {
	  PlanetX.api("get", "http://apis.skplanetx.com/melon/charts/topgenres?count=10&page=1&version=1", "JSON", {'version': 1}, melonchart2);
};
...
/*	console.log("AAA".prototype + " - " + "AAA".byteLength());
	console.log("aaa".prototype + " - " + "aaa".byteLength());
	console.log("가나다".prototype + " - " + "가나다".byteLength());*/
	var result;
	var i = 0;
